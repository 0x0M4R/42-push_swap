...
//push 
int first_00(t_list *list,int i)
{
    int j=0;
    while (list)
    {
...
void push_to_bottom(t_list **list_a, t_list **list_b, int i, int len)
{
    ...
    while (j < len)
    {
        ...
        {
            c=0;
            //push to on top of first bottom 0!
            //rr until reached first 00
                /*
            while(c<first_00(list_b,i))
            {
...
void connect(t_list **list_a, t_list **list_b, int i)
{
